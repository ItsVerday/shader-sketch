@nomangle simplex_noise_4d_permute simplex_noise_4d_taylorInvSqrt simplex_noise_4d_grad simplex_noise_4d fractal_simplex_noise_4d curl_simplex_noise_4d curl_fractal_simplex_noise_4d
