@nomangle RayMarch iterations maxIterations position direction epsilon finished hit smallestDistance closestPosition emission create_raymarch iterate_raymarch raymarch_normal raymarch_ambient_occlusion raymarch_emission
