@nomangle CLOVER_NOISE_2D_POINT_SPREAD CLOVER_NOISE_2D_PI clover_noise_2d_hash clover_noise_2d_offset clover_noise_2d fractal_clover_noise_2d curl_clover_noise_2d curl_fractal_clover_noise_2d
...
vec2 clover_noise_2d_offset(vec2 p, float hash) {
    vec2 offset = vec2(sin(hash * CLOVER_NOISE_2D_PI * 100.), cos(hash * CLOVER_NOISE_2D_PI * 100.)) * floor(hash * 50. + 1.) * .01 + .5;
