...
class ShaderSketchElement extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.shadow.appendChild(this.shaderSketch.buffer);
    ...
    disconnectedCallback() {
        this.mounted = false;
        this.shadow.removeChild(this.shaderSketch.buffer);
    ...
    updateSize() {
        ...
        this.shaderSketch.buffer.width = width;
        this.shaderSketch.buffer.style.width = width >= 1 ? width : 1;
        this.shaderSketch.buffer.height = height;
        this.shaderSketch.buffer.style.height = height >= 1 ? height : 1;
